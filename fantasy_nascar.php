            ...
            <div id="tab1" class="tab-pane fade in active">
                <div class="row top_margin">
                    <div class="col-lg-8 col-lg-offset-2">
                        <h3 style="color: #fff;text-align: center;">Texas Motor Speedway Driver Splits</h3>
                    ...
                    <div class="col-lg-2 col-lg-offset-5">
                        <select class="form-control" data-target=".my-scoreboard" id="theSelect">
                            ...
                            if($_GET['year'] == '2018') {
                                ...
                                echo '<option value="twenty-nine" data-show=".week29" selected="selected">Semi-Final Round (Weeks 29-32)</option>';
