...
$casey_mears = new Season_Driver("Casey Mears");
...
$parker_kligerman = new Season_Driver("Parker Kligerman");

$season_drivers = array($parker_kligerman,$bj_mcleod,$brendan_gaughan,$tyler_reddick,$casey_mears,$cody_ware,$jamie_mcmurray,$ross_chastain,$michael_mcdowell,$joey_logano,$kyle_larson,$ty_dillon,$austin_dillon,$ricky_stenhouse,$aric_almirola,$denny_hamlin,$chris_buescher,$landon_cassill,$alex_bowman,$martin_truex,$ryan_newman,$brad_keselowski,$erik_jones,$david_ragan,$corey_lajoie,$chase_elliott,$paul_menard,$kyle_busch,$kevin_harvick,$daniel_suarez,$ryan_blaney,$jimmie_johnson,$clint_bowyer,$derrike_cope,$jeffrey_earnhardt,$kurt_busch,$matt_DiBenedetto,$bubba_wallace,$william_byron,$ryan_preece,$matt_tifft,$tanner_berryhill,$daniel_hemric);
...
$team_docks = new Team("#1 Team Docks","Jimmie Johnson","Alex Bowman","Ryan Newman","Trevor Bayne");
$team_nick = new Team("#4 Team Nick","Martin Truex Jr","Clint Bowyer","Chris Buescher","Michael McDowell");
$team_matt = new Team("#2 Team Matt","Chase Elliott","Ryan Blaney","Matt DiBenedetto","Dale Earnhardt Jr");
$team_rachel = new Team("#3 Team Rachel","Brad Keselowski","Daniel Suarez","Daniel Hemric","Matt Kenseth");
